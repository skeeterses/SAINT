...
(defun scientificExpression (func dx)
  (match func
	 ...
	 ((guard (list 'expt a 1) t) (derive a dx))	 
	 ((guard (list 'expt a 0) (or (listp a) (constant? a) (variable? a))) 0) 
	 ((guard (list 'expt a b) (and (variable? a) (numberp b)))
	  (list (list b 'expt a (- b 1)) (derive a dx)))
	 ((guard (list 'expt a b) (and (constant? a) (variable? b)))
	  (list (list 'expt a b) (list 'log a)) (derive b dx))
	 ((guard (list 'exp a) t)
	  (list (list 'exp a) (derive a dx)))
	 ((guard (list 'log a) (variable? a))
	  (list (list 1 '/ a) (derive a dx)))
	 ((guard (list 'log a b) (and (numberp b) (> b 0) (/= b 1) (variable? a)))
	  (list (list (list 'log 'exp b) '/ a) (derive a dx)))
	 ))
